...
class Test_min(BaseImageDataset):
    ...
    def __init__(self, root='datasets', verbose=True, **kwargs):
        ...
        query, gallery = self._preprocess(self.test_txt, is_train=False)

        if verbose:
            print("=> vessel loaded")
            self._print_dataset_statistics(query, gallery)
    ...
    def _print_dataset_statistics(self, query, gallery):
